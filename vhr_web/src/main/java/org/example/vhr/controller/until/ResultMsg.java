...
public class ResultMsg {
    ...
    public static ResultMsg equipment_occupy = new ResultMsg(10001,"您已在另一台设备登录，本次登录已下线!");
    public static ResultMsg LOGIN_TIMEOUT = new ResultMsg(10002,"登录超时");
    // Compiler error messages
    public static final ResultMsg  MULTIPLE_STYLESHEET_ERR = new ResultMsg(10002,"多个样式错误!");
    public static final ResultMsg TEMPLATE_REDEF_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg TEMPLATE_UNDEF_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg VARIABLE_REDEF_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg VARIABLE_UNDEF_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg CLASS_NOT_FOUND_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg METHOD_NOT_FOUND_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg ARGUMENT_CONVERSION_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg FILE_NOT_FOUND_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg INVALID_URI_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg FILE_ACCESS_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
    public static final ResultMsg MISSING_ROOT_ERR = new ResultMsg(10002,"TEMPLATE_REDEF_ERR");
